...
int main()
{
    ...
    auto vertex_shader = OOGL::Shader::from_source(GL_VERTEX_SHADER, R"(#version 330 core
    ...
    auto fragment_shader = OOGL::Shader::from_source(GL_FRAGMENT_SHADER, R"(#version 330 core
		out vec4 FragColor;
	...
	std::cout << "vertex shader: "   << (GLuint)vertex_shader << std::endl;
	std::cout << "fragment shader: " << (GLuint)fragment_shader << std::endl;
